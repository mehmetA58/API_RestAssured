...
//De Serialization Yöntemi
       ...
       //JsonPath Yöntemi
        ...
        Assert.assertEquals(expectedRequestData.getJSONObject("bookingdates").getString("checkin"),json.getJsonObject("booking.bookingdates.checkin"));
        Assert.assertEquals(expectedRequestData.getJSONObject("bookingdates").getString("checkout"),json.getJsonObject("booking.bookingdates.checkout"));
    }
}
